...
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../DE0_nano_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is DE0_nano_system
SOPC_NAME := DE0_nano_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2000900
SOPC_SYSID_FLAG += --sidp=0x2000900
ELF_PATCH_FLAG  += --sidp 0x2000900

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1513433802
SOPC_SYSID_FLAG += --timestamp=1513433802
ELF_PATCH_FLAG  += --timestamp 1513433802
